...
module.exports = {
	...
	async execute(interaction) {
		...
		// record 1 second
		execSync('ffmpeg -y -hide_banner -loglevel warning -draw_mouse 0 -f x11grab -r 30 -video_size 850x630 -i :1+100,70 -q:v 0 -pix_fmt yuv422p -t 1 /tmp/screen.mp4', (error, stdout, stderr) => {
			if (error) {
